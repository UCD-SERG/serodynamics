...
dcase <- read_csv("inst/extdata/elisa_clean_2024-06-05.csv") |>
  filter(Arm == "Prospective Cases" & Country == "Nepal") |>
  mutate(
    antigen_iso = paste(elisa_antigen, "_", elisa_antbdy_iso,
                        sep = ""),
...
dcase |> 
  write_csv(
    "inst/extdata/SEES_Case_Nepal_ForSeroKinetics_02-13-2025.csv"
  )
