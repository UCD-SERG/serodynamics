...
setwd("~/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Research/EF_longitudinal/Data for serokinetics")
library(tidyverse)

dcase <- read_csv("/Users/kristenaiemjoy/Documents/GitHub/serodynamics/inst/extdata/elisa_clean_2024-06-05.csv") %>%
  ...
  select(Country, person_id, sample_id, bldculres, antigen_iso, studyvisit,  dayssincefeveronset,  result) 
