...
Source:
[`DESCRIPTION`](https://github.com/UCD-SERG/serodynamics/blob/main/DESCRIPTION)

Teunis P, Schildhauer S, Lee K, Aiemjoy K, Morrison D (2026).
*serodynamics: What the Package Does (One Line, Title Case)*. R package
version 0.0.0.9058, <https://github.com/UCD-SERG/serodynamics>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 0.0.0.9058},
