...
#' @description
#'  `jags_unpack()` takes an MCMC output from run_mod and unpacks it correctly
#'  including for all population parameters.
#' @param data A [dplyr::tbl_df()] output object from run_mod
#' @returns An [dplyr::tbl_df()] that
