...
#'  \itemize{
#'    \item scalar: `B`, `nsubj`, `n_params` (should be 5)
#'    \item hypermeans: `mu.hyp[b, ]`, hyper-precisions: `prec.hyp[b, , ]`
#'    \item Wishart pieces: `OmegaP[5,5]`, `nuP`, `OmegaB[B,B]`, `nuB`
...
model {
  ...
  TauP[1:5,1:5] ~ dwish(OmegaP[1:5,1:5], nuP)      # within-biomarker (params)
