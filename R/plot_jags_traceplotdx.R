...
plot_jags_trace <- function(data=jags.post,iso=unique(visualize_jags_sub$Iso_type), param=unique(visualize_jags_sub$Parameter_sub)) {
  ...
  ## Creating traceplot
  traceplot <- ggs_traceplot(visualize_jags_plot)
  traceplot
}
