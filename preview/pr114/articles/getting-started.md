...
#> Welcome to JAGS 4.3.2 on Wed Apr  8 10:32:29 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Wed Apr  8 10:32:42 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Wed Apr  8 10:32:44 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https://ucd-serg.github.io/serodynamics/preview/pr114/reference/index.md)
...
#>  serocalculator   1.4.0.9009 2026-04-08 [1] Github (ucd-serg/serocalculator@ae4e72c)
