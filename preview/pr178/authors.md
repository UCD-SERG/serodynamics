...
Source:
[`DESCRIPTION`](https://github.com/UCD-SERG/serodynamics/blob/copilot/add-prior-predictive-check-utils/DESCRIPTION)

Teunis P, Schildhauer S, Aiemjoy K, Morrison D (2026). *serodynamics:
What the Package Does (One Line, Title Case)*. R package version
0.0.0.9048, <https://github.com/UCD-SERG/serodynamics>.
