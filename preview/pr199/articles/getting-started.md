...
#> Welcome to JAGS 4.3.2 on Thu Apr 30 06:40:40 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Thu Apr 30 06:40:50 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Thu Apr 30 06:40:52 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#>  serocalculator   1.4.0.9009 2026-04-30 [1] Github (ucd-serg/serocalculator@ae4e72c)
#>  serodynamics   * 0.0.0.9048 2026-04-30 [1] local
