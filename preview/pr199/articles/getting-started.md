...
#> Welcome to JAGS 4.3.2 on Wed Apr 22 13:29:36 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Wed Apr 22 13:29:49 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Wed Apr 22 13:29:51 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https:/ucd-serg.github.io/serodynamics/preview/pr199/reference/index.md)
...
#>  Rcpp             1.1.1-1    2026-04-22 [1] Custom
...
#>  serocalculator   1.4.0.9009 2026-04-22 [1] Github (ucd-serg/serocalculator@ae4e72c)
#>  serodynamics   * 0.0.0.9048 2026-04-22 [1] local
