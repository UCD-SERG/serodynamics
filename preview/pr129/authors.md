...
Source:
[`DESCRIPTION`](https://github.com/UCD-SERG/serodynamics/blob/correlated-biomarkers-qmd/DESCRIPTION)

Teunis P, Schildhauer S, Aiemjoy K, Morrison D (2025). *serodynamics:
What the Package Does (One Line, Title Case)*. R package version
0.0.0.9041, <https://github.com/UCD-SERG/serodynamics>.
    ...
    @Manual{,
      ...
      year = {2025},
      note = {R package version 0.0.0.9041},
