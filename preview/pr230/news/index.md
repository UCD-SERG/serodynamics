...
- Renamed user-facing functions for clarity
  ...
  - [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr230/reference/run_mod.md)
    →
    [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr230/reference/run_serodynamics.md)
  - `post_summ()` →
...
- [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr230/reference/calc_fit_mod.md)’s
...
- [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr230/reference/plot_residuals.md)/[`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr230/reference/calc_fit_mod.md)
