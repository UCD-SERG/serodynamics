...
- Implemented multi-version documentation with dropdown menu for package
  versions, based on insightsengineering/tern setup. Documentation is
  now versioned by tags and branch, with the latest release as the
