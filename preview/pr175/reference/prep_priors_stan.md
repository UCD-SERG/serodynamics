...
allow for modifiable priors for Stan models. Returns Stan-compatible
prior specifications (matrix inversions are handled in the Stan model
itself).
...
A "curve_params_priors_stan" object (a subclass of
...
#> 
#> attr(,"class")
#> [1] "curve_params_priors_stan" "list"                    
#> attr(,"used_priors")
