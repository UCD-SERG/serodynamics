...
Source:
[`DESCRIPTION`](https://github.com/UCD-SERG/serodynamics/blob/copilot/convert-jags-model-to-stan/DESCRIPTION)
...
package version 0.1.0.9001, <https://github.com/UCD-SERG/serodynamics>.
