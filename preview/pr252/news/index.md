...
- Renamed user-facing functions for clarity
  ...
  - [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr252/reference/run_mod.md)
    →
...
- [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr252/reference/run_mod.md)’s
...
- Updated the internals of
  [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr252/reference/calc_fit_mod.md)
