...
- [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/run_serodynamics.md)
  now supplies explicit, numerically stable starting values for
  subject-level JAGS parameters instead of relying on JAGS to invent
  them. This avoids platform-specific initialization failures seen on
  Windows with the power-decay model
  ([\#320](https://github.com/UCD-SERG/serodynamics/issues/320)).
...
- Added
  [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_residuals.md)
  ...
  via
  [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/calc_fit_mod.md),
...
- Added
  [`plot_serocurve()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_serocurve.md)
...
- Renamed user-facing functions for clarity
  ...
  - [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/run_mod.md)
    →
    [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/run_serodynamics.md)
  - `post_summ()` →
    [`summarize_posterior()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/summarize_posterior.md)
  - `plot_jags_trace()` →
    [`plot_trace()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_trace.md)
  - `plot_jags_dens()` →
    [`plot_density()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_density.md)
  - `plot_jags_Rhat()` →
    [`plot_rhat()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_rhat.md)
  - `plot_jags_effect()` →
    [`plot_ess()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_ess.md)
...
- [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/calc_fit_mod.md)’s
...
- [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_residuals.md)/[`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/calc_fit_mod.md)
...
- Making
  [`prep_priors()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/prep_priors.md)
...
- Added
  [`plot_predicted_curve()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/plot_predicted_curve.md)
...
- Added
  [`postprocess_jags_output()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/postprocess_jags_output.md)
  to API ([\#33](https://github.com/UCD-SERG/serodynamics/issues/33))
- Added
  [`initsfunction()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/initsfunction.md)
...
- Added
  ...
  to API ([\#37](https://github.com/UCD-SERG/serodynamics/issues/37))
- Added
  [`as_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/as_case_data.md)
...
- Added examples for `sim_pop_data()`,
  [`autoplot.case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/autoplot.case_data.md)
...
- Added units tests for
  [`prep_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/prep_data.md),
  [`sim_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/sim_case_data.md)
  ([\#18](https://github.com/UCD-SERG/serodynamics/issues/18))
