...
#> Welcome to JAGS 4.3.2 on Thu Sep 10 09:25:16 2026
...
#> 1         1     1 alpha     HlyE_IgA None           1       0.0000362
#> 2         2     1 alpha     HlyE_IgA None           1       0.0000320
#> 3         3     1 alpha     HlyE_IgA None           1       0.0000320
#> 4         4     1 alpha     HlyE_IgA None           1       0.0000320
#> 5         5     1 alpha     HlyE_IgA None           1       0.0000320
#> 6         6     1 alpha     HlyE_IgA None           1       0.0000320
```
...
#>  1 HlyE_IgA alpha     None            0.0000547  5.12e-5 4.06e-5 9.41e-6 2.66e-5
#>  2 HlyE_IgA shape     None            1.16       5.47e-2 1.15e+0 1.09e+0 1.13e+0
#>  3 HlyE_IgA t1        None            1.05       2.76e-1 1.03e+0 6.65e-1 8.66e-1
#>  4 HlyE_IgA y0        None            3.06       1.02e+0 2.73e+0 1.90e+0 2.44e+0
#>  5 HlyE_IgA y1        None           28.5        5.02e+1 1.50e+1 3.75e+0 6.04e+0
#>  6 HlyE_IgG alpha     None            0.0000468  6.68e-5 2.59e-5 4.39e-6 1.45e-5
#>  7 HlyE_IgG shape     None            1.21       1.16e-1 1.19e+0 1.07e+0 1.10e+0
#>  8 HlyE_IgG t1        None            1.79       1.13e+0 1.35e+0 6.91e-1 9.31e-1
#>  9 HlyE_IgG y0        None            3.11       1.86e+0 2.34e+0 1.39e+0 1.62e+0
#> 10 HlyE_IgG y1        None           32.2        3.18e+1 1.71e+1 3.18e+0 6.44e+0
#> # ℹ 15 more rows
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Thu Sep 10 09:25:28 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Thu Sep 10 09:25:30 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https:/ucd-serg.github.io/serodynamics/preview/pr322/reference/index.md)
...
#>  purrr            1.2.2      2026-04-10 [1] any (@1.2.2)
