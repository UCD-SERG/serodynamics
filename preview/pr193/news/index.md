...
- Added
  ...
  using posterior samples of the `mu.par` hyperparameter (or optionally
  the “newperson” subject). Supports 95% credible interval ribbons,
  stratified curves with colour or faceting, and multiple
  antigen-isotypes
...
- [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr193/reference/run_mod.md)’s
...
- Updated the internals of
  [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr193/reference/calc_fit_mod.md)
