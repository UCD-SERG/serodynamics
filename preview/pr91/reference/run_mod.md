...
- nmc:
  ...
  An [integer](https://rdrr.io/r/base/integer.html) specifying number of
  samples in posterior chains
...
- A jags.post [`list()`](https://rdrr.io/r/base/list.html) object or
  multiple jags.post [`list()`](https://rdrr.io/r/base/list.html) if
  stratified. Returned as a [`list()`](https://rdrr.io/r/base/list.html)
  of class
...
#> Welcome to JAGS 4.3.2 on Tue Apr 15 03:06:40 2025
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Tue Apr 15 03:07:26 2025
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
