...
- Added R 4.5+ snapshot variants to handle the changed attribute
  ...
  ([\#109](https://github.com/ucdavis/serodynamics/issues/109)).
...
- Reorganized pkgdown documentation with new “Getting Started” guide
  ...
  ([\#73](https://github.com/ucdavis/serodynamics/issues/73)).
...
- Including fitted and residual values as data frame in run_mod output.
  ([\#101](https://github.com/ucdavis/serodynamics/issues/101))
- Added
  ...
  ([\#68](https://github.com/ucdavis/serodynamics/issues/68))
- Replacing old data object with new run_mod output
  ([\#102](https://github.com/ucdavis/serodynamics/issues/102))
- Adding class assignment to run_mod output
  ([\#76](https://github.com/ucdavis/serodynamics/issues/76))
- Making prep_priors modifiable
  ([\#78](https://github.com/ucdavis/serodynamics/issues/78))
- Changes to
  [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/run_mod.md)
  output:
...
- Changes to
  [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/run_mod.md)
  ([\#79](https://github.com/ucdavis/serodynamics/issues/79)):
...
- Diagnostic function to produce R-hat dotplots with stratification
  ([\#67](https://github.com/ucdavis/serodynamics/issues/67))
- Added function for summarizing estimates in a table
  ([\#74](https://github.com/ucdavis/serodynamics/issues/74))
- Diagnostic trace plot function with strat
  ([\#64](https://github.com/ucdavis/serodynamics/issues/64))
- Diagnostic function to produce effective sample size plots with
  stratification
  ([\#66](https://github.com/ucdavis/serodynamics/issues/66))
- Diagnostic function to produce density plots with stratification
  ([\#27](https://github.com/ucdavis/serodynamics/issues/27))
- Added SEES data set data folder and documentation
  ([\#41](https://github.com/ucdavis/serodynamics/issues/41))
- Fixing SEES data and added jags_post for SEES
  ([\#63](https://github.com/ucdavis/serodynamics/issues/63))
- [`as_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/as_case_data.md)
  now creates column `visit_num`
  ([\#47](https://github.com/ucdavis/serodynamics/issues/47),
  [\#50](https://github.com/ucdavis/serodynamics/issues/50))
- Added
  [`postprocess_jags_output()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/postprocess_jags_output.md)
  to API ([\#33](https://github.com/ucdavis/serodynamics/issues/33))
- Added
  [`initsfunction()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/initsfunction.md)
  to API ([\#37](https://github.com/ucdavis/serodynamics/issues/37))
- Added participant IDs as names to `nsmpl` element of
  [`prep_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/prep_data.md)
  output ([\#34](https://github.com/ucdavis/serodynamics/issues/34))
- Added
  [`initsfunction()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/initsfunction.md)
  to API ([\#37](https://github.com/ucdavis/serodynamics/issues/37))
- Added
  [`as_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/as_case_data.md)
  to API ([\#31](https://github.com/ucdavis/serodynamics/issues/31))
- Added
  [`prep_priors()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/prep_priors.md)
  to API ([\#30](https://github.com/ucdavis/serodynamics/issues/30))
- Added
  [`autoplot()`](https://ggplot2.tidyverse.org/reference/autoplot.html)
  method for `case_data` objects
  ([\#28](https://github.com/ucdavis/serodynamics/issues/28))
- Added examples for `sim_pop_data()`,
  ...
  ([\#18](https://github.com/ucdavis/serodynamics/issues/18))
- Added attributes as a return to the run_mod function
  ([\#24](https://github.com/ucdavis/serodynamics/issues/24))
- exported
  [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr207/reference/run_mod.md)
  function ([\#22](https://github.com/ucdavis/serodynamics/issues/22))
- Function that runs jags with option of stratification included.
  ([\#14](https://github.com/ucdavis/serodynamics/issues/14))
- Changed package name to serodynamics.
  ([\#19](https://github.com/ucdavis/serodynamics/issues/19),
  [\#20](https://github.com/ucdavis/serodynamics/issues/20))
...
- Switched ggmcmc dependency from GitHub dev version to CRAN v1.5.1.2
  ([\#135](https://github.com/ucdavis/serodynamics/issues/135))
- vectorized `ab()` function
  ([\#116](https://github.com/ucdavis/serodynamics/issues/116))
- Added `lintr::undesirable_function_linter()` to `.lintr.R`
  ([\#81](https://github.com/ucdavis/serodynamics/issues/81))
...
- Added various GitHub Actions
  ([\#10](https://github.com/ucdavis/serodynamics/issues/10),
  [\#15](https://github.com/ucdavis/serodynamics/issues/15),
  [\#18](https://github.com/ucdavis/serodynamics/issues/18))
