...
|----|----|
| [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/run_serodynamics.md) | [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/run_mod.md) |
| [`plot_trace()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/plot_trace.md) | `plot_jags_trace()` |
| [`plot_density()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/plot_density.md) | `plot_jags_dens()` |
| [`plot_rhat()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/plot_rhat.md) | `plot_jags_Rhat()` |
| [`plot_ess()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/plot_ess.md) | `plot_jags_effect()` |
| [`summarize_posterior()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/summarize_posterior.md) | `post_summ()` |
...
#> Welcome to JAGS 4.3.2 on Mon Sep 14 17:40:10 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Mon Sep 14 17:40:16 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Mon Sep 14 17:40:33 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Mon Sep 14 17:40:35 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#>  serodynamics   * 0.1.0.9022 2026-09-14 [1] local
