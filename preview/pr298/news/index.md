...
- Added
  ...
  via
  [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/calc_fit_mod.md),
...
- Renamed user-facing functions for clarity
  ...
  - [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/run_mod.md)
    →
    [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/run_serodynamics.md)
  - `post_summ()` →
...
- [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/plot_residuals.md)/[`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr298/reference/calc_fit_mod.md)
