...
\<\<\<\<\<\<\< HEAD (Priors used in below code were selected based on
[^1]) **Users should always specify priors according to their own data
set.**

======= Stratified kinetic models can be generated by specifying a
covariate via the `strat` argument, enabling separate model fits for
subgroups defined by age group, serotype, geography, or other
covariates, used when kinetic parameters may vary across populations.
...
> > > > > > > f5162fc1231270820bce45e2d678b8c9ff592d3d
...
#> Welcome to JAGS 4.3.2 on Tue Sep 15 04:10:50 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Tue Sep 15 04:11:03 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Tue Sep 15 04:11:04 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https:/ucd-serg.github.io/serodynamics/preview/pr284/reference/index.md)
  for complete API documentation
- Check out example datasets:
  [`?nepal_sees`](https:/ucd-serg.github.io/serodynamics/preview/pr284/reference/nepal_sees.md),
  [`?nepal_sees_jags_output`](https:/ucd-serg.github.io/serodynamics/preview/pr284/reference/nepal_sees_jags_output.md)
