...
- ...:
  ...
  :   A [numeric](https://rdrr.io/r/base/numeric.html)
      ...
      parameters (y0, y1, t1, r, alpha) for each biomarker. Must be 5
  ...
  :   A [numeric](https://rdrr.io/r/base/numeric.html)
      ...
      corresponding to the 5 estimated parameters.
  ...
  :   A [numeric](https://rdrr.io/r/base/numeric.html)
      ...
      long corresponding to the 5 estimated parameters.
...
#> Welcome to JAGS 4.3.2 on Fri Aug 21 18:34:15 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Fri Aug 21 18:35:19 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
