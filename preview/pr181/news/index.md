...
- Repository polish:
  ...
  - Standardized file extensions: renamed `load_data.r` and
    `prep_data.r` to use uppercase `.R` extension for consistency
  - Completed
    [`load_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr181/reference/load_data.md)
    function documentation (replaced “to add” placeholder)
