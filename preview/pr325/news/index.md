...
- Added `draw_new_individual_params()` and its helpers
  ...
  `draw_mvn_from_precision()`
  ([\#302](https://github.com/UCD-SERG/serodynamics/issues/302)). These
  draw kinetic parameters for a hypothetical new individual from the
  fitted population distribution `MVN(mu.par, solve(prec.par))` after
  the model is fit, rather than from a synthetic all-missing subject
  inside the sampler. Sampling uses the Cholesky factor of the precision
  matrix rather than inverting it, which also rejects a draw whose
  precision matrix is not positive definite. The parameter order is read
  from the `mu.par` rows, so a decay type with a different parameter set
  needs no special case. These functions are not yet wired into
  [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/run_serodynamics.md),
  and
  [`prep_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/prep_data.md)
  still adds the `newperson` subject.
...
- Added
  [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_residuals.md)
  ...
  via
  [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/calc_fit_mod.md),
...
- Added
  [`plot_serocurve()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_serocurve.md)
...
- Renamed user-facing functions for clarity
  ...
  - [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/run_mod.md)
    →
    [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/run_serodynamics.md)
  - `post_summ()` →
    [`summarize_posterior()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/summarize_posterior.md)
  - `plot_jags_trace()` →
    [`plot_trace()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_trace.md)
  - `plot_jags_dens()` →
    [`plot_density()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_density.md)
  - `plot_jags_Rhat()` →
    [`plot_rhat()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_rhat.md)
  - `plot_jags_effect()` →
    [`plot_ess()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_ess.md)
...
- [`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/calc_fit_mod.md)’s
...
- [`plot_residuals()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_residuals.md)/[`calc_fit_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/calc_fit_mod.md)
...
- Added
  [`plot_predicted_curve()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/plot_predicted_curve.md)
...
- Added
  [`postprocess_jags_output()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/postprocess_jags_output.md)
  to API ([\#33](https://github.com/UCD-SERG/serodynamics/issues/33))
- Added
  [`initsfunction()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/initsfunction.md)
...
- Added
  ...
  to API ([\#37](https://github.com/UCD-SERG/serodynamics/issues/37))
- Added
  [`as_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/as_case_data.md)
...
- Added examples for `sim_pop_data()`,
  [`autoplot.case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/autoplot.case_data.md)
...
- Added units tests for
  [`prep_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/prep_data.md),
  [`sim_case_data()`](https:/ucd-serg.github.io/serodynamics/preview/pr325/reference/sim_case_data.md)
  ([\#18](https://github.com/UCD-SERG/serodynamics/issues/18))
