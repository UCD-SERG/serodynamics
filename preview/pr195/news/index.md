...
- Added standalone documentation page for the `sr_model` class,
  describing all data columns and attributes including the upcoming
  `population_params` attribute from PR
