...
|----|----|
| [`run_serodynamics()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/run_serodynamics.md) | [`run_mod()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/run_mod.md) |
| [`plot_trace()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/plot_trace.md) | `plot_jags_trace()` |
| [`plot_density()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/plot_density.md) | `plot_jags_dens()` |
| [`plot_rhat()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/plot_rhat.md) | `plot_jags_Rhat()` |
| [`plot_ess()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/plot_ess.md) | `plot_jags_effect()` |
| [`summarize_posterior()`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/summarize_posterior.md) | `post_summ()` |
...
#> Welcome to JAGS 4.3.2 on Fri Sep 25 04:14:54 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Fri Sep 25 04:15:04 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Fri Sep 25 04:15:05 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/index.md)
  for complete API documentation
- Check out example datasets:
  [`?nepal_sees`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/nepal_sees.md),
  [`?nepal_sees_jags_output`](https:/ucd-serg.github.io/serodynamics/preview/pr310/reference/nepal_sees_jags_output.md)
...
#>  serodynamics   * 0.1.0.9024 2026-09-25 [1] local
