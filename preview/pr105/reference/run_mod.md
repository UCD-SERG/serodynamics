...
- data:
  ...
  the following columns. These values can be clarified as inputs using
  [`as_case_data()`](https://ucd-serg.github.io/serodynamics/preview/pr105/reference/as_case_data.md)
  if not explicitly labeled as so.

  - id_var = The ID of individuals included

  - biomarker_var = The different antigen isotype combinations that are
    being measured
...
#> Welcome to JAGS 4.3.2 on Sat Jul  5 03:35:50 2025
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Sat Jul  5 03:36:38 2025
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
