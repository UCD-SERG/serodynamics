test_that("add_factor_priors appends prec.lambda and zero_p", {
...
test_that("add_factor_priors default works, rejects bad prec_lambda", {
...
test_that("make_inits_2a returns RNG seeds and positive starts", {
  ...
  # loading starts have the right shape and obey lambda[1,] > 0
  ...
  expect_false(
    identical(inits_fun(1)[[".RNG.seed"]], inits_fun(2)[[".RNG.seed"]])
  )
})
