...
#> Welcome to JAGS 4.3.2 on Mon Jun  8 22:55:11 2026
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Mon Jun  8 22:55:24 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
#> Following the progress of chain 1 (the program will wait for all chains
#> to finish before continuing):
#> Welcome to JAGS 4.3.2 on Mon Jun  8 22:55:26 2026
#> JAGS is free software and comes with ABSOLUTELY NO WARRANTY
#> Loading module: basemod: ok
#> Loading module: bugs: ok
#> . . Reading data file data.txt
...
- See the [function
  reference](https://ucd-serg.github.io/serodynamics/reference/index.md)
...
#>  serocalculator   1.4.0.9014 2026-06-08 [1] Github (ucd-serg/serocalculator@c2f5169)
#>  serodynamics   * 0.0.0.9056 2026-06-08 [1] local
